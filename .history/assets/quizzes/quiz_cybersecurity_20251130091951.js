...
DMI_QUESTION_SETS["cybersecurity"] = {
  ...
  questions: [
    ...
    },
    {
      ...
      Evidence: "DR test logs, backup automation reports.",
      choices: [
        { value: 1, text: "1. Manual backup and DR processes." },
        { value: 2, text: "2. Basic backup systems with manual tests." },
        { value: 3, text: "3. Managed digital backup system." },
        { value: 4, text: "4. Automated DR testing and dashboards." },
        { value: 5, text: "5. Fully automated, self-healing resilience architecture." }
      ]
    }
  ],
