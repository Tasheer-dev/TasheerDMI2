...
questions: [
  { id:"Q1", area:"Digital Finance Roadmap", title:"Digital Finance Roadmap", text:"Is there a documented digital finance strategy aligned with organizational goals?", choices:[
  ...
  { id:"Q2", area:"Leadership Support", title:"Leadership Support", text:"How strong is leadership support for digital finance initiatives?", choices:[
  ...
  { id:"Q3", area:"Digital Governance", title:"Digital Governance", text:"How structured is governance for finance systems and digital initiatives?", choices:[
    {value:1,text:"1. None"},
  ...
  { id:"Q4", area:"Risk & Controls Integration", title:"Risk & Controls Integration", text:"How well are financial risks and controls digitized into workflows?", choices:[
  ...
  { id:"Q5", area:"ERP Usage", title:"ERP Usage", text:"How effectively is the ERP used for finance operations?", choices:[
  ...
  { id:"Q6", area:"System Integration", title:"System Integration", text:"Are financial systems integrated with other departments (HR, procurement, sales)?", choices:[
  ...
  { id:"Q7", area:"Process Automation", title:"Process Automation", text:"How automated are key finance processes?", choices:[
  ...
  { id:"Q8", area:"Digital Document Management", title:"Digital Document Management", text:"How mature is the digitization of finance-related documents?", choices:[
  ...
  { id:"Q9", area:"Financial Data Quality", title:"Financial Data Quality", text:"How reliable and consistent is financial data?", choices:[
  ...
  { id:"Q10", area:"Reporting Automation", title:"Reporting Automation", text:"How automated are recurring financial reports?", choices:[
  ...
  { id:"Q11", area:"Analytics Capability", title:"Analytics Capability", text:"How effectively is analytics used for financial decision-making?", choices:[
  ...
  { id:"Q12", area:"Data Integration", title:"Data Integration", text:"How well integrated are financial data sources?", choices:[
  ...
  { id:"Q13", area:"Regulatory Compliance", title:"Regulatory Compliance", text:"How digitized are compliance reporting and validation processes?", choices:[
  ...
  { id:"Q14", area:"Internal Controls", title:"Internal Controls", text:"How automated are key financial controls?", choices:[
  ...
  { id:"Q15", area:"Audit Readiness", title:"Audit Readiness", text:"How easy is it to retrieve finance data for audits?", choices:[
  ...
  { id:"Q16", area:"Fraud Prevention", title:"Fraud Prevention", text:"How mature are digital fraud detection mechanisms?", choices:[
    {value:1,text:"1. None"},
  ...
  { id:"Q17", area:"Procure-to-Pay Automation", title:"Procure-to-Pay Automation", text:"How automated is the procure-to-pay cycle?", choices:[
    {value:1,text:"1. Manual"},
    {value:2,text:"2. Basic"},
  ...
  { id:"Q18", area:"Accounts Payable Automation", title:"Accounts Payable Automation", text:"How automated is invoice processing and AP workflow?", choices:[
  ...
  { id:"Q19", area:"Accounts Receivable Automation", title:"Accounts Receivable Automation", text:"How automated is AR invoicing, reminders, and collections?", choices:[
    {value:1,text:"1. Manual"},
  ...
  { id:"Q20", area:"Payment Systems Maturity", title:"Payment Systems Maturity", text:"How digitized and automated are payment processes?", choices:[
  ...
  { id:"Q21", area:"Budgeting Automation", title:"Budgeting Automation", text:"How automated is the budgeting process?", choices:[
  ...
  { id:"Q22", area:"Forecasting Accuracy", title:"Forecasting Accuracy", text:"How advanced are forecasting models?", choices:[
  ...
  { id:"Q23", area:"Performance Dashboards", title:"Performance Dashboards", text:"How mature are financial performance dashboards?", choices:[
  ...
  { id:"Q24", area:"Scenario Planning Maturity", title:"Scenario Planning Maturity", text:"How mature is scenario planning?", choices:[
    {value:1,text:"1. None"},
  ...
  { id:"Q25", area:"Workflow Automation", title:"Workflow Automation", text:"How automated are financial approval workflows?", choices:[
  ...
  { id:"Q26", area:"RPA Adoption", title:"RPA Adoption", text:"How effectively is RPA used in finance operations?", choices:[
    {value:1,text:"1. None"},
    {value:2,text:"2. Basic"},
  ...
  { id:"Q27", area:"Process Standardization", title:"Process Standardization", text:"How standardized are finance processes across the department?", choices:[
  ...
  { id:"Q28", area:"Cycle Time Efficiency", title:"Cycle Time Efficiency", text:"How optimized are financial cycle times?", choices:[
  ...
  { id:"Q29", area:"Digital Skills", title:"Digital Skills", text:"How strong are digital skills in finance?", choices:[
  ...
  { id:"Q30", area:"Training & Knowledge", title:"Training & Knowledge", text:"How structured is digital training?", choices:[
  ...
  { id:"Q31", area:"Innovation Culture", title:"Innovation Culture", text:"How well does finance adopt new digital tools?", choices:[
  ...
  { id:"Q32", area:"Finance–IT Collaboration", title:"Finance–IT Collaboration", text:"How mature is collaboration between Finance and IT?", choices:[
    {value:1,text:"1. Weak"},
