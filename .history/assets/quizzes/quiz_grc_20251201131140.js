...
DMI_QUESTION_SETS["grc"] = {
  ...
  questions: [
    ...
    // -------------------------------------------------------------
    {
      ...
      text: "Is the policy governance Policy of policies and Exectiive manual  formally defined, approved, and managed through a digital platform with clear ownership and responsibilities?",
      Evidence: "Policy framework documents, governance model, ownership matrix, digital policy portal.",
      choices: [
        { value: 1, text: "No structured policy-governance process; activities handled ad-hoc." },
