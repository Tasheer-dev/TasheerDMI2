...
DMI_QUESTION_SETS["grc"] = {
  ...
  questions: [
    ...
    // -------------------------------------------------------------
    {
      ...
      text: "Is the policy governance Policy of policies and  manual charter  formally defined, approved, and managed through a digital platform with clear ownership and responsibilities?",
