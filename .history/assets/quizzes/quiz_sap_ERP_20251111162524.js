  ...
  questions: [
    {
      ...
      choices: [
        ...
        { value: 4, text: "4. Digital catalogue in SAP/portal with SLA visibility and regular reviews." },
    ...
    },
    {
      ...
      text: "Are service intake channels (SAP, ITSM, email-to-ticket) standardized and adopted by all business units?",
      ...
      choices: [
        ...
        { value: 3, text: "3. Standard SAP portal/ITSM used by most departments." },
        { value: 4, text: "4. All requests via SAP portal/ITSM with routing and prioritization rules." },
