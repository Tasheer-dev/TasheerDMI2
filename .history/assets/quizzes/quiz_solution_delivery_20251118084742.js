...
DMI_QUESTION_SETS["solution_delivery"] = {
  ...
  questions: [
    ...
    // -------------------------------------------------------------------------
    {
      ...
      choices: [
        { value: 0, text: "No Agile practices; work handled reactively without structured sprints." },
...

    {
      ...
      choices: [
        { value: 0, text: "No formal interaction; requirements arrive informally without clarity." },
...

    {
      ...
      choices: [
        { value: 0, text: "No formal tracking; problems addressed only when they escalate." },
...

    {
      ...
      choices: [
        { value: 0, text: "No governance; reporting unstructured and inconsistent." },
    ...
    // -------------------------------------------------------------------------
    {
      ...
      choices: [
        { value: 0, text: "ADO barely used; work tracked mainly outside the system." },
...

    {
      ...
      choices: [
        { value: 0, text: "Builds and deployments fully manual without pipelines." },
...

    {
      ...
      choices: [
        { value: 0, text: "Testing fully manual without usable automated suites." },
...

    {
      ...
      choices: [
        { value: 0, text: "Releases performed without planning or approvals." },
    ...
    // -------------------------------------------------------------------------
    {
      ...
      choices: [
        { value: 0, text: "No coding standards or review practices exist." },
...

    {
      ...
      choices: [
        { value: 0, text: "Integrations built ad-hoc with minimal documentation." },
...

    {
      ...
      choices: [
        { value: 0, text: "Architecture undocumented and stored only in minds." },
    ...
    // -------------------------------------------------------------------------
    {
      ...
      choices: [
        { value: 0, text: "No formal QA process; testing unstructured." },
...

    {
      ...
      choices: [
        { value: 0, text: "Defects not systematically logged or tracked." },
...

    {
      ...
      choices: [
        { value: 0, text: "No dedicated test environments exist." },
    ...
    // -------------------------------------------------------------------------
    {
      ...
      choices: [
        { value: 0, text: "Teams work independently with minimal collaboration." },
...

    {
      ...
      choices: [
        { value: 0, text: "No structured engagement with Operations." },
...

    {
      ...
      choices: [
        { value: 0, text: "Processes undocumented; teams rely on verbal knowledge." },
    ...
    // -------------------------------------------------------------------------
    {
      ...
      choices: [
        { value: 0, text: "Tools available but rarely used effectively." },
...

    {
      ...
      choices: [
        { value: 0, text: "Knowledge not captured formally; onboarding informal." },
...

    {
      ...
      choices: [
        { value: 0, text: "No mechanism exists for proposing improvements." },
