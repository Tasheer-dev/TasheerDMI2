...
/* =============================================================================
   ...
   With Tasheer Logo + Styled Header + Centered Columns + Footer
   ============================================================================= */
async function exportAllReportsToExcel() {
  ...
  Object.keys(localStorage).forEach(key => {
    ...
    // Add footer separator and branding row
    rows.push([]);
    rows.push(["", "", "", "", "Generated by Tasheer Digital Maturity Tool © Tasheer Company"]);
    ...
    for (let R = range.s.r; R <= range.e.r; ++R) {
      for (let C = range.s.c; C <= range.e.c; ++C) {
        ...
        // Data rows
          ...
          if (C === 2) baseStyle.alignment.horizontal = "center"; // Center Selected Level
          cell.s = baseStyle;
        }
        // Footer (last row)
        else if (R === range.e.r) {
