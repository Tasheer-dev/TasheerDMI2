...
function initAdminPage() {
  // Ensure user is logged in before loading the admin page
  ...
  deptButtons.forEach(btn => {
    btn.addEventListener("click", () => {
      ...
      // Compute overall company DMI (if needed for dashboard)
      const companyScore = computeCompanyOverallDMI();
      // TODO: use companyScore to update UI if required
  ...
  // Auto-select FIRST department on page load
